...
End-to-end tests (Playwright, builds and runs the app automatically):

```bash
npx playwright test
```

Both run automatically in CI (`.github/workflows/ci.yml`) on every push and pull request, alongside `npm run lint`.
